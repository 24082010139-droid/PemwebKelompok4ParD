  ...
  <div class="container mx-auto">
    <div class="flex flex-wrap items-center">
      ...
      <div class="w-full px-4 lg:w-1/2">
        <h2 class="text-base font-semibold text-teal-500 md:text-xl mb-1">
        ...
        <p class="font-medium text-slate-400 mb-8 leading-relaxed">
          ...
          project modifikasi website SI BanTal (Sistem Informasi Bantuan Sosial)
          kelompok 4 ini, saya berkontribusi dalam perancangan antarmuka dan
          penulisan kode HTML, CSS, JS agar tampilan lebih modern dan responsif.
        </p>
