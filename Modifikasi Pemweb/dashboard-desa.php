                        ...
                        <table class="w-full text-left border-collapse min-w-max">
                            ...
                            <tbody class="text-sm text-slate-700">
                                <?php if($result_my_req && mysqli_num_rows($result_my_req) > 0): ?>
                                    ...
                                    <?php endwhile; ?>
                                <?php else: ?>
                                    <tr><td colspan="4" class="p-8 text-center text-slate-500">Belum ada form pengajuan yang Anda buat.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse min-w-max">
                            ...
                            <tbody class="text-sm text-slate-700">
                                <?php if($result_apply && mysqli_num_rows($result_apply) > 0): ?>
                                    ...
                                    <?php endwhile; ?>
                                <?php else: ?>
                                    <tr><td colspan="4" class="p-8 text-center text-slate-500">Anda belum mengambil program donatur manapun.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
